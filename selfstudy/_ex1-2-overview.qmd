...
[data analysis workflow](/methods/common-workflow.qmd) and principles
of [safeguarding data](/methods/safeguard-data.qmd), we adopt a
**metadata-driven approach** — using a data dictionary as an
...
[Self-Study → GMD requirements](/selfstudy/gmd-requirements.qmd).
...
The full example, including suggested prompts and instructions, is in
`C:/WBG/ai/ai4coding-practice/ex02-understand-data/` in the self-study section. You can follow along
