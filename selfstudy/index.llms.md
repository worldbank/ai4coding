...
- **Example 0** is a quick test of your setup. If you haven’t completed it yet, start here. All you need are fulfilled [minimal prerequisite requirements](../prerequisites/index.llms.md),

- **Example 1** is an introduction to the Positron + Copilot workflow using Stata. It’s a great place to start if you’re new to AI-assisted coding or want to get comfortable with the tools. It covers the basics AI tools such as: inline suggestions, chat mode, inline chat, and agent mode. [Example 1](../selfstudy/example-1.llms.md) contains detailed instructions and suggested prompts to guide you through the process. Finally, there is an [18 min video walkthrough](https://www.youtube.com/watch?v=U29xAoivY5Y) in case you want to follow along.

- **Example 2** is a live demonstration of using AI to clean and prepare for analysis Mexico’s ENIGH survey (2016 and 2018). Full details, suggested prompts, and instructions are in [Example 2](../selfstudy/example-2.llms.md).
...
- **Example 3** is a final example with less hand-holding that gives you the opportunity to practice AI for data analysis tasks with bare minimum guidance. It contains an example of a data analysis from the past and asks you to reproduce, revise, and reuse it with the help of AI by adding an additional survey year. This is one of the most common tasks. Full details and instructions are in [Example 3](../selfstudy/example-3.llms.md).

# Supporting materials

- [Global Monitoring Database (GMD) variables description](../selfstudy/gmd-requirements.llms.md) is a key reference for the Example 2.
