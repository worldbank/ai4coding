...
- Open Positron.
- Create a new wioring directory in `C:\WBG\ai\` called `ex00-positron-test`.
...
- Ask AI how to create a new `.R` script in positrons and write a simple R code to print "Hello World".
...
If there are no results, common problemsmay include:
...
- Python package UV dose not work properly >>> check [Common Problems](common-problems.qmd#python-uv-installation-problem)
