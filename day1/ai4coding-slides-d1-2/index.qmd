...
## ![](/assets/img/claude.svg){style="width:40px;height:40px;vertical-align:middle;"} What about Claude Code? {.small-slide}
...
Quick [[Example 0]{.fg}](/selfstudy/example-0.qmd){target="_blank"} to verify your setup.
...
## Example 2: Understanding and cleaning the data {.small-slide}

**You will practice using AI to:**

1. Set a clear objective and constraints for an AI session
2. Build a **data dictionary** (variable names, types, labels) as the AI intermediary
3. Document harmonization requirements as a **mapping table**
4. Generate modular cleaning code following [DIME Wiki](https://dimewiki.worldbank.org/) best practices
5. Iterate, verify with an independent auditor session, and document results

Full details and prompts: [Self-Study → Example 2](/selfstudy/example-2.qmd){target="_blank"}
