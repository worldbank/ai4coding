...
- Basic inline completions still works.
:::
...
This exercise is pre-recorded for self-study (18 min), full details, suggested prompts, and instructions are in the [Self-Study > Example 1](/selfstudy/ex1-1-explore-positron.qmd){target="_blank"}.
