---
title: "AI for Coding"
subtitle: "Day 1: Software & Account Setup"
author:
  - name: Eduard Bukin
...
::: {.callout-important}
You can only have [**one active plan**]{.alert}. WB access **automatically cancels and refunds** your private subscription. Switching back requires re-subscribing and is possible in the end of a month.
:::
...
[What are premium requests?]{.fg} — Every chat/agent interaction with advanced models (Claude Sonnet, GPT-5+) consumes (x1-x3) **premium request**.
...
[Fall-back: Personal GH + Private Copilot Pro & budget.]{.note}

[300 premium requests per month is sufficient with thoughtful usage.]{.fg}
