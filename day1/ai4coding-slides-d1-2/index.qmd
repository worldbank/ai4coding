...
If any problems arise: follow the [troubleshooting guide](/prerequisites/index.qmd) or contact [ITHelp@worldbankgroup.org](mailto:ITHelp@worldbankgroup.org).
...
Check **usage** at [GitHub Settings → Copilot](https://github.com/settings/copilot/features){target="_blank"}.
...
## ![](/assets/img/claude.svg){style="width:40px;height:40px;vertical-align:middle;"} What about Claude Code? {.tiny-slide}
...
## What next? {.small-slide}

::::: {.columns}
:::: {.column width="50%"}
[**Example 1: Explore Positron & Copilot**]{.fg}

Get familiar with AI assistance features — create a Stata do-file, write code with AI, and execute it in the console.

Pre-recorded self-study (18 min) → [Example 1](/selfstudy/example-1.qmd){target="_blank"}
::::

:::: {.column width="50%"}
[**Example 2: Understand & clean data**]{.fg}

Use AI to build a data dictionary, document harmonization, generate modular cleaning code, and verify results.

Full details and prompts → [Example 2](/selfstudy/example-2.qmd){target="_blank"}
::::
:::::
