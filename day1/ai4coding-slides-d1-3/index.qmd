...
::: columns
::: {.column width="48%"}
![LLM training illustration from 3Blue1Brown](images/3b1b-training.jpg){width="100%" .fragment .center}
:::
::: {.column width="2%"}
:::
::: {.column width="48%"}
![Backpropagation illustration from 3Blue1Brown](images/3b1b-backpropogation.jpg){width="100%" .fragment .center}
:::
:::
...
![Next-token prediction example from 3Blue1Brown](images/3b1b-predictions.jpg){ width="100%" .center}
...
![Context-dependent LLM prediction from 3Blue1Brown](images/llm-prediction-2.png){width="100%" .center}
