...
![Interface of the Positron IDE showing Activity Bar, Primary Side Bar, Editor, Panel, and Secondary Side Bar](../../assets/images/user-interface-for-rstudio-migration.jpeg){fig-alt="Positron IDE with labeled regions: Activity Bar on the far left, Primary Side Bar to its right, Editor in the center, Panel below the editor, and Secondary Side Bar on the right."}
...
![Positron IDE showing how to access settings through the command palette](img/command-palette.gif){fig-alt="Positron IDE showing how to access settings through the command palette."}
...
> ![](img/settings-reset.gif){fig-alt="Positron IDE showing how to reset settings to their default values."}
