...
> Adopted from Positron UI <https://positron.posit.co/layout.html>
...
To use the assistant's AI features, you need to [Enable Positron Assistant](https://positron.posit.co/assistant-getting-started.html#step-1-enable-positron-assistant) and [Configure GitHub Copilot](https://positron.posit.co/assistant-getting-started.html#step-2-configure-language-model-providers). Other useful
