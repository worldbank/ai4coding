### Be careful about what you write in prompts {#be-careful}
...
[Chapter 5 — Processing confidential data](https://worldbank.github.io/dime-data-handbook/processing.html#processing-confidential-data)
and
[Chapter 4 — Handling data securely](https://worldbank.github.io/dime-data-handbook/acquisition.html#handling-data-securely).
:::
...
### Use metadata and move data outside of the working folder {#use-metadata}
...
This approach aligns with the de-identification workflow recommended in the DIME Data Handbook;
see [Chapter 5 — Implementing de-identification](https://worldbank.github.io/dime-data-handbook/processing.html#implementing-de-identification).
...
as possible [^2] [^2a] [^3] [^4].

[^2]: IHSN. *Microdata Anonymization*. <https://www.ihsn.org/anonymization>
[^2a]: Bjarkefur, Cardoso de Andrade, Daniels & Jones. *Development Research in Practice: The DIME Analytics Data Handbook* — Chapter 5: Processing confidential data. <https://worldbank.github.io/dime-data-handbook/processing.html#processing-confidential-data>
